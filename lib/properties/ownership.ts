...
export const PROPERTY_OWNERSHIP: PropertyOwnership[] = [
...

  {
    ...
    owners: [
      ...
      { id: "k1-7300-aisard",    name: "Amy C Isard",              vendorCode: "AMYC1",                                                                                     address: "Grandweg 146",                   city: "Hamburg",       state: "Germany",      zip: "",     profitPct: 0.031300000, lossPct: 0.031300000, capitalPct: 0.031300000 },
