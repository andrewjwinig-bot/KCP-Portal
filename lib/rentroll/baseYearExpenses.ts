...
// not yet loaded (blank on the workbook). No Condo line. Maintenance
// Salaries had no 2020 entry, seeded as $0. Occupancy through 2025.
const YEARS_4080 = [
...
const SEED_4080: PropertyExpenses = {
  ...
  opEx: zip(YEARS_4080, [
    ...
    642691, 667644, 676252, 510144, 646121, 698820, 698820, 708018,
  ]),
  opExGrossedUp: zip(YEARS_4080, [
    571375, 652673, 674000, 627950, 646345, 651514, 631571,
    642691, 686112, 702250, 617730, 740222, 698820, 817070, 861396,
  ]),
  ret: {},
  occupancyPct: {
  ...
  lines: [
    { glAccount: "6130-8502", label: "Water / Sewer", values: zip(YEARS_4080, [16630, 26367, 25281, 31755, 28857, 27923, 26533, 22502, 20983, 15467, 20701, 15447, 17131, 17131, 23900]) },
    { glAccount: "6220-8502", label: "Building Maintenance", values: zip(YEARS_4080, [129696, 114791, 104550, 110164, 119519, 105895, 134234, 91923, 130855, 135560, 160180, 193088, 176450, 176450, 284987]) },
    { glAccount: "6030-8502", label: "Maintenance Salaries", values: zip(YEARS_4080, [40907, 37064, 37674, 42263, 39857, 37739, 39345, 44063, 42186, 43368, 0, 33502, 26628, 26628, 23476]) },
    { glAccount: "6270-8502", label: "Trash Removal", values: zip(YEARS_4080, [7040, 9954, 13331, 13457, 16438, 14692, 16580, 18593, 20820, 19606, 11890, 16365, 16200, 16200, 21197]) },
    { glAccount: "6360-8502", label: "Parking Lot Maint.", values: zip(YEARS_4080, [39274, 26636, 79819, 30643, 15315, 17493, 27434, 50022, 32219, 86034, 61688, 42149, 96000, 96000, 20322]) },
    { glAccount: "6350-8502", label: "Security", values: zip(YEARS_4080, [23860, 21623, 22686, 22231, 24321, 22939, 25216, 25696, 24156, 18493, 21840, 20610, 26024, 26024, 6499]) },
    { glAccount: "6370-8502", label: "Snow Removal", values: zip(YEARS_4080, [38601, 28495, 45229, 25991, 25241, 48229, 36848, 26009, 31769, 20311, 7146, 34919, 43756, 43756, 19928]) },
    { glAccount: "6380-8502", label: "Landscaping", values: zip(YEARS_4080, [36795, 40479, 40865, 37329, 44912, 45289, 39810, 42802, 50659, 58990, 39826, 48581, 44729, 44729, 45377]) },
    { glAccount: "6510-8502", label: "Insurance", values: zip(YEARS_4080, [38831, 25480, 27117, 28656, 30598, 30435, 28388, 38540, 27826, 36539, 35328, 42016, 58620, 58620, 69791]) },
    { glAccount: "6610-8502", label: "Management Fee", values: zip(YEARS_4080, [72652, 120857, 133032, 129407, 94257, 114704, 112800, 117788, 120588, 107350, 59783, 74486, 64797, 64797, 62553]) },
    { glAccount: "6250-8502", label: "Cleaning", values: zip(YEARS_4080, [127089, 150118, 144416, 156054, 159457, 138668, 144383, 164753, 165583, 134534, 91762, 124958, 128485, 128485, 129988]) },
    { glAccount: "6610-8502-95", label: "Management Fee (95%)", grossedUp: true, values: zip(YEARS_4080, [72652, 143518, 133032, 129407, 111931, 136212, 112800, 117788, 128370, 118888, 102225, 109630, 64797, 104440, 112383]) },
    { glAccount: "6250-8502-95", label: "Cleaning (95%)", grossedUp: true, values: zip(YEARS_4080, [127089, 178266, 144416, 156054, 189356, 164669, 144383, 164753, 176269, 148994, 156906, 183916, 128485, 207092, 233536]) },
    { glAccount: "6120-8502", label: "Electric", separateCharge: true, values: { "2019": 294383, "2020": 226150, "2021": 223360 } },
  ],
  updatedAt: "2026-02-03",
};
