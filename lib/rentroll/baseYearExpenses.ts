...
const SEED_40C0: PropertyExpenses = {
  propertyCode: "40C0",
  rentableSqft: 18000,
  opEx: zip(YEARS_40C0, [21530, 35528, 34529, 39168, 37279, 33869, 35689, 44075]),
  opExGrossedUp: zip(YEARS_40C0, [21530, 35528, 34529, 39168, 37279, 33869, 35689, 44075]),
  ret: { "2025": 34210 },
  occupancyPct: {},
  occupancyMonthly: {},
  lines: [
    ...
    { glAccount: "6350-8502", label: "Security", values: zip(YEARS_40C0, [3751, 2913, 3413, 3081, 1681, 0, 1015, 1952]) },
