...
// 2013; 2025 expenses are not yet finalized. Occupancy is known through 2025.
const YEARS_4050 = [
...
const SEED_4050: PropertyExpenses = {
  ...
  opEx: zip(YEARS_4050, [
    ...
    263372, 280094, 228332, 238476, 306034, 234956, 275847,
  ]),
  opExGrossedUp: zip(YEARS_4050, [
    236015, 236077, 228772, 240136, 279427, 319568, 280216,
    302605, 304835, 263478, 292721, 358854, 286376, 333513,
  ]),
  ret: zip(YEARS_4050, [
    124758, 113471, 116490, 121518, 123678, 125839, 126919,
    129079, 111550, 100595, 101105, 101402, 115381, 106865,
  ]),
  occupancyPct: {
  ...
  lines: [
    { glAccount: "6130-8502", label: "Water / Sewer", values: zip(YEARS_4050, [7704, 11400, 9883, 11334, 10715, 10977, 11224, 10774, 14542, 15450, 16511, 17175, 18153, 19824]) },
    { glAccount: "6220-8502", label: "Building Maintenance", values: zip(YEARS_4050, [41557, 64533, 43817, 56132, 63858, 84156, 71526, 86693, 68577, 64463, 67305, 77830, 68545, 88913]) },
    { glAccount: "6030-8502", label: "Maintenance Salaries", values: zip(YEARS_4050, [16880, 15561, 15909, 15596, 16260, 18195, 18786, 17979, 18486, 17775, 14495, 9695, 7320, 7680]) },
    { glAccount: "6270-8502", label: "Trash Removal", values: zip(YEARS_4050, [5239, 6584, 8491, 11474, 13278, 12650, 14020, 14950, 13181, 12734, 14111, 17190, 18718, 21653]) },
    { glAccount: "6360-8502", label: "Parking Lot Maint.", values: zip(YEARS_4050, [24023, 6968, 9023, 5766, 10286, 6485, 227, 7279, 25186, 6589, 2277, 61535, 4878, 7187]) },
    { glAccount: "6350-8502", label: "Security", values: zip(YEARS_4050, [9221, 9061, 9507, 9532, 10312, 11036, 11220, 10547, 8112, 9555, 10067, 6218, 3649, 2843]) },
    { glAccount: "6370-8502", label: "Snow Removal", values: zip(YEARS_4050, [10787, 11160, 17423, 20025, 17958, 14125, 11039, 13899, 10803, 3085, 8896, 6700, 0, 8719]) },
    { glAccount: "6380-8502", label: "Landscaping", values: zip(YEARS_4050, [10422, 7268, 8506, 8456, 9756, 11455, 9185, 15961, 8383, 9935, 14675, 13272, 9118, 12958]) },
    { glAccount: "6510-8502", label: "Insurance", values: zip(YEARS_4050, [15358, 9752, 10489, 16051, 12777, 11022, 13411, 10118, 13584, 13200, 19091, 20067, 26905, 29380]) },
    { glAccount: "6610-8502", label: "Management Fee", values: zip(YEARS_4050, [39736, 32190, 31443, 31662, 33372, 29397, 24538, 25341, 34438, 28124, 23502, 25242, 24627, 23365]) },
    { glAccount: "6250-8502", label: "Cleaning", values: zip(YEARS_4050, [55088, 61600, 64281, 54108, 53443, 68662, 46316, 49831, 64802, 47422, 47547, 51110, 53042, 53326]) },
    { glAccount: "6610-8502-95", label: "Management Fee (95%)", grossedUp: true, values: zip(YEARS_4050, [39736, 32190, 31443, 31662, 43909, 41811, 41412, 38567, 43023, 41208, 41446, 42704, 40931, 40934]) },
    { glAccount: "6250-8502-95", label: "Cleaning (95%)", grossedUp: true, values: zip(YEARS_4050, [55088, 61600, 64281, 54108, 70317, 97656, 78166, 75838, 80957, 69484, 83849, 86467, 88158, 93423]) },
    { glAccount: "6120-8501", label: "Electric", separateCharge: true, values: { "2019": 78690, "2020": 75005, "2021": 78019, "2024": 88139 } },
  ],
  updatedAt: "2026-02-03",
};

// 4060 — Building 6 (NI LLC). No operating-expense data for 2011 or 2014;
// 2025 expenses pending. No Condo or Electric lines. Occupancy through 2025.
const YEARS_4060 = [
...
const SEED_4060: PropertyExpenses = {
  ...
  opEx: zip(YEARS_4060, [
    ...
    537561, 508474, 478226, 559345, 661363, 565512, 572157,
  ]),
  opExGrossedUp: zip(YEARS_4060, [
    472477, 492653, 504873, 511679, 526089, 536819, 555772,
    537561, 534668, 496010, 574146, 678272, 604719, 639534,
  ]),
  ret: zip(YEARS_4060, [
    251384, 266488, 309644, 311802, 237358, 278356, 280514,
    284830, 252599, 232114, 232115, 233285, 233969, 195511,
  ]),
  occupancyPct: {
  ...
  lines: [
    { glAccount: "6130-8502", label: "Water / Sewer", values: zip(YEARS_4060, [18870, 21511, 24353, 22088, 25814, 29973, 31287, 24612, 25267, 28806, 22775, 13122, 32569, 48470]) },
    { glAccount: "6220-8502", label: "Building Maintenance", values: zip(YEARS_4060, [104787, 94956, 94434, 93778, 100975, 117592, 166775, 124139, 117425, 117404, 135176, 158840, 135442, 145583]) },
    { glAccount: "6030-8502", label: "Maintenance Salaries", values: zip(YEARS_4060, [33418, 30973, 35647, 33533, 33019, 36204, 37379, 35776, 36777, 35363, 28347, 22467, 22467, 14760]) },
    { glAccount: "6270-8502", label: "Trash Removal", values: zip(YEARS_4060, [8137, 8100, 12432, 12239, 15080, 11454, 13373, 17065, 14927, 10337, 16217, 18000, 16585, 20138]) },
    { glAccount: "6360-8502", label: "Parking Lot Maint.", values: zip(YEARS_4060, [8303, 22717, 14958, 10797, 13111, 7789, 3251, 10833, 9553, 5126, 9179, 58800, 11990, 14384]) },
    { glAccount: "6350-8502", label: "Security", values: zip(YEARS_4060, [18649, 18755, 18666, 20680, 21190, 21350, 21688, 20388, 15597, 18427, 17465, 22214, 7038, 5483]) },
    { glAccount: "6370-8502", label: "Snow Removal", values: zip(YEARS_4060, [25145, 28762, 22358, 21025, 36903, 9216, 9568, 26805, 8850, 6166, 30174, 39052, 13830, 16814]) },
    { glAccount: "6380-8502", label: "Landscaping", values: zip(YEARS_4060, [23448, 29325, 17810, 32747, 27759, 31209, 26286, 37013, 25238, 22441, 30501, 30838, 38043, 28514]) },
    { glAccount: "6510-8502", label: "Insurance", values: zip(YEARS_4060, [24606, 21881, 24601, 25286, 24090, 25094, 31109, 23788, 31547, 30576, 35916, 50400, 54714, 59730]) },
    { glAccount: "6610-8502", label: "Management Fee", values: zip(YEARS_4060, [84223, 89411, 106391, 81381, 83783, 84992, 85565, 88693, 89349, 76243, 84407, 96593, 88912, 78942]) },
    { glAccount: "6250-8502", label: "Cleaning", values: zip(YEARS_4060, [122891, 126262, 133223, 120309, 124904, 140677, 129491, 128449, 133944, 127338, 149188, 151037, 143922, 139339]) },
    { glAccount: "6610-8502-95", label: "Management Fee (95%)", grossedUp: true, values: zip(YEARS_4060, [84223, 89411, 106391, 96640, 91596, 93003, 85565, 88693, 99830, 82903, 89755, 103189, 103884, 103309]) },
    { glAccount: "6250-8502-95", label: "Cleaning (95%)", grossedUp: true, values: zip(YEARS_4060, [122891, 126262, 133223, 142867, 136552, 153936, 129491, 128449, 149656, 138462, 158641, 161350, 168158, 182349]) },
  ],
  updatedAt: "2026-02-03",
};

// 4070 — Building 7 (NI LLC). Workbook only carries 2014, 2016 and
// 2018-2024; 2025 expenses pending. No Condo line. Occupancy through 2025.
const YEARS_4070 = [2014, 2016, 2018, 2019, 2020, 2021, 2022, 2023, 2024];

const SEED_4070: PropertyExpenses = {
  propertyCode: "4070",
  rentableSqft: 61508,
  opEx: zip(YEARS_4070, [
    287388, 246459, 325443, 322698, 308242, 343463, 348227, 329075, 328357,
  ]),
  opExGrossedUp: zip(YEARS_4070, [
    287388, 246459, 337511, 342262, 320595, 349109, 362431, 355021, 369699,
  ]),
  ret: zip(YEARS_4070, [
    158076, 152540, 156230, 159853, 142457, 130169, 130551, 144882, 137584,
  ]),
  occupancyPct: {
  ...
  lines: [
    { glAccount: "6130-8502", label: "Water / Sewer", values: zip(YEARS_4070, [12548, 11604, 15067, 15805, 15875, 14312, 16445, 18155, 19544]) },
    { glAccount: "6220-8502", label: "Building Maintenance", values: zip(YEARS_4070, [68194, 25862, 83064, 73961, 73014, 88823, 77866, 84596, 84521]) },
    { glAccount: "6030-8502", label: "Maintenance Salaries", values: zip(YEARS_4070, [18048, 20711, 20475, 21047, 20238, 16380, 10959, 8280, 8280]) },
    { glAccount: "6270-8502", label: "Trash Removal", values: zip(YEARS_4070, [10565, 9410, 14078, 16535, 13532, 14211, 17738, 18730, 22078]) },
    { glAccount: "6360-8502", label: "Parking Lot Maint.", values: zip(YEARS_4070, [10193, 5493, 7090, 16186, 3010, 6459, 25304, 5794, 7505]) },
    { glAccount: "6350-8502", label: "Security", values: zip(YEARS_4070, [11103, 12693, 11346, 8645, 10237, 10774, 7580, 3910, 3046]) },
    { glAccount: "6370-8502", label: "Snow Removal", values: zip(YEARS_4070, [23415, 16261, 14892, 7957, 3436, 9531, 7178, 0, 9341]) },
    { glAccount: "6380-8502", label: "Landscaping", values: zip(YEARS_4070, [20817, 26802, 28024, 22167, 25698, 23964, 26046, 33766, 25160]) },
    { glAccount: "6510-8502", label: "Insurance", values: zip(YEARS_4070, [13569, 13105, 12870, 16916, 16488, 24640, 25371, 31164, 34023]) },
    { glAccount: "6610-8502", label: "Management Fee", values: zip(YEARS_4070, [30126, 28295, 42921, 43561, 48560, 48786, 50528, 43983, 38395]) },
    { glAccount: "6250-8502", label: "Cleaning", values: zip(YEARS_4070, [68810, 76223, 75616, 79918, 78156, 85581, 83211, 80696, 76464]) },
    { glAccount: "6610-8502-95", label: "Management Fee (95%)", grossedUp: true, values: zip(YEARS_4070, [30126, 28295, 47291, 50463, 53294, 50836, 55894, 53135, 52214]) },
    { glAccount: "6250-8502-95", label: "Cleaning (95%)", grossedUp: true, values: zip(YEARS_4070, [68810, 76223, 83314, 92580, 85775, 89177, 92049, 97489, 103986]) },
    { glAccount: "6120-8502", label: "Electric", separateCharge: true, values: { "2019": 107804, "2020": 80885, "2021": 85849, "2022": 109580, "2023": 85849, "2024": 125825 } },
  ],
  updatedAt: "2026-02-03",
};
