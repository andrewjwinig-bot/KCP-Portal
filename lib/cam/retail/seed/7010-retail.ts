...
// PRS + admin now live in the CAM config seed (lib/cam/retailConfigSeed.ts) so
// the unit page and reconciliation share one source. The roster carries only
// rent-roll facts — SF, escrow billed, partial-year occupancy — plus the pad
// CAM-pool overrides (a pool mechanic, not a unit-page input).
export const ROSTER_7010_RETAIL_2025: RetailRosterUnit[] = [
  { unitRef: "7010-1230A", suite: "1230A", name: "Wawa, Inc.",              sqft: 6237, camPoolOverride: 311728.70, camEscrow: 31440, insEscrow: 0, retEscrow: 12468 },
  ...
  { unitRef: "7010-12360", suite: "12360", name: "Trumark Fin.",            sqft: 2280, camPoolOverride: 373375.18, camEscrow: 15324, insEscrow: 360, retEscrow: 4560 },
  { unitRef: "7010-12363", suite: "12363", name: "Philly Soft Pretzel Factory", sqft: 1988, camEscrow: 13944, insEscrow: 312, retEscrow: 3972 },
  { unitRef: "7010-12375", suite: "12375", name: "Dunkin Donuts",           sqft: 3200, camPoolOverride: 373375.18, camEscrow: 20592, insEscrow: 0, retEscrow: 6396 },
