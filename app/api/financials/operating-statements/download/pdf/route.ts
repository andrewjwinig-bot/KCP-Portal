...
import { buildStatementPdf } from "@/lib/financials/operating-statements/statementExport";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";
export const revalidate = 0;

// GET /api/financials/operating-statements/download/pdf?key&year[&period]
export async function GET(req: Request) {
  try {
    ...
    const buf = await buildStatementPdf(loaded.statement, loaded.meta);
