...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const isPublic = PUBLIC_PATHS.has(pathname) || pathname.startsWith("/statement/") || pathname.startsWith("/portal/") || pathname.startsWith("/investor/") || pathname.startsWith("/budget-review/") || pathname.startsWith("/centers/");
