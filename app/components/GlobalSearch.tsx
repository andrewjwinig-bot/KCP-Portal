...
const PAGES: PageEntry[] = [
  ...
  { label: "Investor Info", href: "/investors", navKey: "investors",
    ...
    keywords: ["investors", "partners", "owners", "vendor", "vendor code", "ownership"] },
  { label: "Statement of Values", href: "/investors?view=statement", navKey: "investors",
    description: "Each owner's estimated value by ownership % (year-end + estimate)",
    keywords: ["statement of values", "sov", "estimated value", "estimated values", "equity", "ownership percentage", "ownership %", "k-1", "k1", "owner value", "partner value", "distributions"] },
