...
export const config = {
  ...
  matcher: [
    "/((?!_next/static|_next/image|_next/data|favicon.ico|images|login|submit|service|reserve|api/site/login|api/site/logout|api/maintenance/inbound|api/maintenance/submit|api/tenants|api/reservations/submit|api/reservations/tenants).*)",
  ],
};
